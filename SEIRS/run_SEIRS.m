...
[T,Y] = ode45(@(t,Y) Fseirs(t,Y,beta,gamma,omega,mu,N),Tspam,S0E0I0R0);
%--
...
plot(T,I,'r--');
plot(T,R,'b-.');
title(['SEIRS model: \beta= ',num2str(beta),', \gamma= ',num2str(gamma), '\omega= ',num2str(omega),  '\mu= ',num2str(mu),', N=',num2str(N)])
xlabel('Time')
